...
print("the top selling in Nestle_roducts is",max_value,"us dollar", max_keys)
max_value = max(Unilever_products.values())  # maximum value
max_keys = [k for k, v in Unilever_products.items() if v == max_value] 

print("the top selling in Unilever_products is",max_value,"US dollar", max_keys)
